        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-4 max-w-[700px] text-muted-foreground">
              Professional lighting services with a Texas touch
            </p>
          </div>
      ...
      <section className="bg-muted py-12 md:py-24">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-4 max-w-[700px] text-muted-foreground">
              Professional lighting solutions for every need
            </p>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Transform your home with stunning Christmas displays
                </p>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Enhance your outdoor spaces year-round
                </p>
                <Button variant="outline" size="sm" asChild>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Professional lighting for special occasions
                </p>
                <Button variant="outline" size="sm" asChild>
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-3">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="mt-4 text-muted-foreground">
                  &quot;Lone Star Lighting transformed our home! The team was professional, on time, and the lights
                  look amazing. We&apos;ll definitely be using them again!&quot;
                </p>
                <div className="mt-6 flex items-center gap-4">
                  <div className="rounded-full bg-muted h-12 w-12 overflow-hidden relative flex-shrink-0">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="mt-4 text-muted-foreground">
                  &quot;Best decision we made! Their premium package made our house the talk of the neighborhood.
                  Worth every penny for the hassle-free experience.&quot;
                </p>
                <div className="mt-6 flex items-center gap-4">
                  <div className="rounded-full bg-muted h-12 w-12 overflow-hidden relative flex-shrink-0">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="mt-4 text-muted-foreground">
                  &quot;As a business owner, I needed a company that could handle a large commercial display. Lone
                  Star delivered beyond expectations and helped bring in more customers!&quot;
                </p>
                <div className="mt-6 flex items-center gap-4">
                  <div className="rounded-full bg-muted h-12 w-12 overflow-hidden relative flex-shrink-0">
