...
const serviceAreas = [
  ...
  },
  {
    city: "Cedar Park",
    slug: "cedar-park",
    description: "Family communities and master-planned neighborhoods in Williamson County",
    neighborhoods: ["Buttercup Creek", "Ranch at Brushy Creek", "Cypress Creek", "Twin Creeks"],
    image: "/images/christmas-colorful.jpeg",
    established: "2022",
    customers: "120+",
  },
  {
    city: "Round Rock",
    slug: "round-rock",
    description: "Residential neighborhoods and commercial corridors along I-35",
    neighborhoods: ["Forest Creek", "Teravista", "Paloma Lake", "Old Town Round Rock"],
    image: "/images/advanced-package.png",
    established: "2022",
    customers: "140+",
  },
  {
    city: "Georgetown",
    slug: "georgetown",
    description: "Historic square, Sun City, and growing communities",
    neighborhoods: ["Sun City", "Historic Downtown Square", "Wolf Ranch", "Berry Creek"],
  ...
  },
  {
    city: "Lakeway",
    slug: "lakeway",
    description: "Luxury waterfront and hillside estates on Lake Travis",
    neighborhoods: ["Rough Hollow", "The Hills", "Flintrock Falls", "Lakeway Highlands"],
    image: "/images/christmas-elegant.png",
    established: "2023",
    customers: "80+",
  },
  {
    city: "Bee Cave",
    slug: "bee-cave",
    description: "Upscale Hill Country homes and the Galleria shopping district",
    neighborhoods: ["Falconhead", "Spanish Oaks", "Uplands", "Hill Country Galleria area"],
    image: "/images/basic-package.png",
    established: "2023",
    customers: "70+",
  },
